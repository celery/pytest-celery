from pytest_celery.healthchecks import HealthCheck, HealthCheckFailedError, DiskSpaceUnavailableError
...
class DiskSpaceAvailable(HealthCheck):
    ...
    def __init__(self, path_to_disk: str, max_disk_size_gb: int = DEFAULT_MAX_DISK_SIZE_GB,
    ...
    def __call__(self) -> None:
        try:
            ...
            if directory_size > self.max_healthy_size:
                raise DiskSpaceUnavailableError(self.path_to_disk, directory_size, self.max_disk_size_gb,
